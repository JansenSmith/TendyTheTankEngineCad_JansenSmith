...
return new ICadGenerator(){
	...
	public ArrayList<CSG> generateBody(MobileBase arg0) {
		...
		armBez.setCP1(bucketDiameter.getMM()/2, armDepth+1, 0)			//Used to reset control point before manually tweaking - JMS, Feb 2023
		armBez.setCP2(bucketDiameter.getMM()/2-1, armDepth, 0)
